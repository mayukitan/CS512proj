...
WARNING: I have not finished eval.py yet.

```
python eval.py <input data file> <actor.csv for testing generated by list_all_x.py> <matrixARA.csv for training generated by pathsim.py>
```

For example,
```
python eval.py '../train_top_author.txt' '../pathsim/test_data/actor.csv' '../pathsim/train_data/matrixARA.csv'
```
